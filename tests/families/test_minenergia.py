...
def test_normalize_title_builds_canonical_code():
    assert _normalize_title("R", "01529", "2026") == "R_MINENERGIA_1529_2026"


def test_normalize_title_pads_short_numbers_to_four_digits():
    assert _normalize_title("D", "6", "2026") == "D_MINENERGIA_0006_2026"


def test_normalize_title_keeps_longer_numbers_unpadded():
    assert _normalize_title("C", "40040", "2026") == "C_MINENERGIA_40040_2026"
...
def test_scrap_parses_listing_and_fetches_detail_for_each_row():
    ...
    assert [d.title for d in docs] == ["R_MINENERGIA_1529_2026", "D_MINENERGIA_1187_2026", "C_MINENERGIA_40040_2026"]
