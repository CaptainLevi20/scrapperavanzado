...
def test_normalize_title_builds_canonical_code():
    assert _normalize_title("D", "1028", "2026") == "D_MI_1028_2026"
...
def test_extraer_item_parses_real_markup_shape():
    ...
    assert doc.title == "D_MI_1028_2026"
    ...
    assert doc.save_path == "Ministerio del Interior/2026-08-05/Decreto/D_MI_1028_2026(extension)"
...
def test_scrap_paginates_and_stops_once_a_doc_is_older_than_fini():
    ...
    assert {d.title for d in docs} == {
        "R_MI_0100_2026", "R_MI_0099_2026", "D_MI_0500_2026",
    }
