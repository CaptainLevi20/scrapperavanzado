...
def test_normalize_title_builds_canonical_code():
    assert _normalize_title("D", "765", "2026") == "D_MA_0765_2026"
...
def test_extraer_articulos_parses_article_and_builds_canonical_title():
    ...
    assert len(docs) == 1
    doc = docs[0]
    assert doc.title == "D_MA_0765_2026"
    ...
    assert doc.save_path == "Ministerio de Agricultura y Desarrollo Rural/2026-07-15/Decreto/D_MA_0765_2026(extension)"
...
def test_extraer_articulos_parses_multiple_articles_in_one_page():
    ...
    assert {d.title for d in docs} == {"D_MA_0765_2026", "D_MA_2311_2023"}
...
def test_scrap_aggregates_across_the_four_categories():
    ...
    assert {d.title for d in docs} == {"L_MA_2311_2023", "D_MA_0212_2023"}
...
def test_scrap_continues_past_a_failing_category():
    ...
    assert {d.title for d in docs} == {"L_MA_2311_2023"}
